...
export function GuestSelector({
  ...
  return (
    <div
      ...
      className="absolute top-[79px] lg:top-auto lg:bottom-[75px] left-0 right-0 z-50 bg-stone-900 backdrop-blur-sm bg-opacity-60 text-white shadow-lg p-6 w-full lg:w-[500px]"
    >
