...
export default async function ExperiencesPage({
  ...
  return (
    <>
      <Hero showBookingBar imgSrc='https://static11.com-hotel.com/uploads/hotel/306737/photo/hotel-mas-el-cuquello_172656168714.jpg' title={t.title} subtitle={t.subtitle} />
